							...
							<div class="col-md-4 col-sm-6 col-sx-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ul class="chat">
											<li class="in">
												<img class="avatar" alt="" src="img/admin11.png">
												<div class="message">
													<span class="arrow">
													</span>
													<a href="#" class="name">
											...
											<li class="out">
												<img class="avatar" alt="" src="img/admin8.png">
												<div class="message">
													<span class="arrow">
													</span>
													<a href="#" class="name">
											...
											<li class="in">
												<img class="avatar" alt="" src="img/admin5.png">
												<div class="message">
													<span class="arrow">
													</span>
													<a href="#" class="name">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<div class="tweets-container">
											...
											<div class="tweet-box">
												<img class="avatar" alt="" src="img/admin2.png">
												<div class="tweet">
													<p>
											...
											<div class="tweet-box">
												<img class="avatar" alt="" src="img/admin1.png">
												<div class="tweet">
													<p>
											...
											<div class="tweet-box no-margin">
												<img class="avatar" alt="" src="img/admin3.png">
												<div class="tweet">
													<p>
												...
												<ul class="signups">
													<li>
														<div class="user pull-left">
															<img src="img/admin2.png" alt="user" >
														</div>
														<div class="info">
															<h6>Sandy</h6>
													...
													<li>
														<div class="user pull-left">
															<img src="img/admin1.png" alt="user" >
														</div>
														<div class="info">
															<h6>Srinu Basava</h6>
													...
													<li>
														<div class="user pull-left">
															<img src="img/admin8.png" alt="user" >
														</div>
														<div class="info">
															<h6>Honey</h6>
													...
													<li>
														<div class="user pull-left">
															<img src="img/admin9.png" alt="user" >
														</div>
														<div class="info">
															<h6>Rahul Dravid</h6>
